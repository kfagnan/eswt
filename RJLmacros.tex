...
\def\bcm{\begin{mat}}   % centered
\def\ecm{\end{mat}}
\def\brm{\begin{rmat}}  % right justified
\def\erm{\end{rmat}}

\newenvironment{pvect}{\left( \begin{array}{c}}{\end{array}\right)}
\def\bpvect{\begin{pvect}}
\def\epvect{\end{pvect}}
...
%\def\choose{\begin{choice}}
%\def\endch{\end{choice}}
...
\newenvironment{lablist}
 {\begin{list}{}{\itemsep 2pt \itemindent -.5in \leftmargin 1in }}{\end{list}}
\newenvironment{reflist}
 {\vskip 10pt \begin{center} {\sc References} \end{center}\vskip 3pt \small
 \begin{list}{}{\itemsep 2pt \itemindent -.5in \leftmargin 1in }}{\end{list}
 \normalsize}
...
%\newtheorem{exampl}{Example}[subsection]
%\newcommand{\example}[1]{\vskip 5pt \begin{exampl}\label{#1}\end{exampl}}
...
\def\ddy{{\partial\over\partial y}}
...
\def\claw{{\sc clawpack}}
\def\amrclaw{{\sc amrclaw}}
...
\def\Dz{\Delta z}
\def\Dt{\Delta t}
\def\dtdx{\frac{\Delta t}{\Delta x}}




% Macros useful for FV methods 
...
\newcommand\Z{{\cal Z}}
\newcommand\tZ{\widetilde {\cal Z}}
\newcommand\A{{\cal A}}
\newcommand\Apm{{\cal A}^{\pm}}
